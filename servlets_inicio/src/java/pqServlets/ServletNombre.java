...
public class ServletNombre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombrePersonaje;nombrePersonaje=request.getParameter("nombre");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Enlace al index.html. Funcionapero mejor usar el NO comentado. 
            //out.println("<p>Pusal <a href="+url+"> aquí</a> para volver</p>");
